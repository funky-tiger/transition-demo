    ...
    return (
      <React.Fragment>
        <div style={{ width: "100vw", height: "100vh" }}>
          ...
          />
          {this.props.control.getAnimationShow(currentShowSec, {
            setting: [
              {
                // 此处传递配置
                startPoint: { x: 450, y: 300 },
            ...
            <div style={{ fontSize: "50px" }}>
              <div style={{ fontSize: "100px" }}>传递的组件1</div>
              <div style={{ fontSize: "10px" }}>传递的组件2</div>
            </div>
          )}
        </div>
      </React.Fragment>
...
export default AnimationControl.control()(VideoPage);
